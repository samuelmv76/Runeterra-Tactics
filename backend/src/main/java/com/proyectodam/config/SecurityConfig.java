    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http
            ...
            .authorizeHttpRequests(auth -> auth
                ...
                .requestMatchers(org.springframework.http.HttpMethod.POST, "/api/salas/*/salir").permitAll()
                .requestMatchers(org.springframework.http.HttpMethod.PUT, "/api/salas/*/iniciar").permitAll()
